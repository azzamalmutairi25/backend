...
//  لها في الوزارة — وهي التي كان الإنتاج يخرج بها. فكل مرشّح يُضاف قبل ضبطها
...
//
//  ⚠ حذف الثمانية التجريبية هنا **مشروط بخلوّها**: قطاعٌ عليه مرشّح أو
...
return new class extends Migration
{
    ...
    {
        // يُحذف المزروع الخالي وحده — قطاعٌ ارتبط بمرشحين يبقى، والتراجع
