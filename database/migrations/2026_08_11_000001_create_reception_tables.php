...
//
//  reception_visits      : وصول المرشّح إلى المركز في يومٍ بعينه، وتوقيعه
//                          وإقراره بصحّة بياناته.
//  reception_assignments : توزيع الاستقبال للمرشّح على نشاطٍ ومقيّم، وقرار
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('reception_visits', function (Blueprint $table) {
            ...
            // التوقيع صورة يرسمها المرشّح — بيانات شخصية حيوية، تُخزَّن مشفَّرة
            // كبقية حقول المرشّح (Crypt). لا عمود بحث عليها ولا فهرس.
        ...
        // إسناد فعّال واحد لكل (زيارة، نشاط): مرشّح لا يكون في مقابلتين معاً.
