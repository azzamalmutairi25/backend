...
// ════════════════════════════════════════════════════════════
//  كشك الاستقبال — جهازٌ لوحيّ في بهو المركز يمرّ عليه المرشحون واحداً
//  بعد واحد: يُدخل المرشّح هويته، فيرى بياناته، فيوقّع، فتُطبع بطاقته.
//
//  لماذا رمزٌ في جدول لا جلسةُ مستخدم؟ لأن الجهاز لا يُسجَّل عليه دخول
//  موظّف: جلسةٌ مفتوحة على جهازٍ يمسكه مرشّحون متعاقبون هي صلاحيةُ موظّفٍ
...
//  بيان قبل مطابقته — نفس مبدأ بوّابة المرشّح (رابط تملكه + هوية تعرفها).
// ════════════════════════════════════════════════════════════
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // المرشّح لا يطبع بنفسه: الطابعة عند مسؤول المرشحين، والكشك يسجّل
        // طلباً فقط. فصلُ الطلب عن التنفيذ يجعل انقطاع الطابعة تأخيراً في
        // الطابور لا فشلاً أمام المرشّح، ويُبقي البطاقات مطبوعةً بترتيبها.
