...
// ════════════════════════════════════════════════════════════
//  بيانات عرض واقعية عبر دورة حياة المشارك كاملة.
//
...
class DemoDataSeeder extends Seeder
{
    ...
    private const RECOMMENDATIONS = [
        ...
        'مشارك مناسب — يحتاج تطويراً محدوداً',
        'مشارك واعد — يحتاج برنامج تطوير',
    ...
    public function run(): void
    {
        ...
        // الأعداد مضاعفات عدد القطاعات ليقع في كل قطاع مشارك من كل حالة — وإلا
        ...
        // نصفها بلا مشارك في بعض الحالات.
        $n = $sectors->count();
        $plan = [
    ...
    {
        $this->seq++;
        // دوّار لا عشوائي: العشوائية تترك قطاعات بمشارك واحد وأخرى بستة، فلا
        ...
        $upper = $this->seq % 3 !== 0; // ثلثا المشاركين فئة عليا
        $rank = $isMil
        ...
        // أغلب المشاركين عاديون؛ قلة مصنّفة لتظهر بوابة التصنيف في الواجهة
        ...
        // مستوى أداء ثابت لكل مشارك تتذبذب حوله درجاته — وإلا كان التوافق ضجيجاً بلا معنى
