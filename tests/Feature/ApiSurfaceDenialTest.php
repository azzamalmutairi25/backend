...
class ApiSurfaceDenialTest extends TestCase
{
    ...
    // `sectorId` و`rankLabel` حقلان إلزاميان في إنشاء المرشّح، ومصدرهما هنا.
    // كلتاهما تُشكّل استجابتها بالصلاحية: البادئات وأعداد المرتبطين — وهي
    // أرقامٌ تكشف حجم كل قطاع — لا تُرسَل إلا لمدير الإعدادات.
