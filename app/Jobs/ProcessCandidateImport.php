...
class ProcessCandidateImport implements ShouldQueue
{
    ...
    // ── طابورٌ واتصالٌ مستقلّان: `imports` لا `default` ──
    ...
    //
    // واتصالُ redis-imports مهلةُ إعادته (٣٩٠٠ث) أطولُ من مهلة الوظيفة
    // (٣٦٠٠ث) كي لا تُطلَق الرفعةُ ثانيةً وهي تعمل فتُعالَج مرّتين — طابورُ
    // redis الافتراضيّ مهلتُه ٩٠ث، تناسب الرسائل لا رفعةً بربع ساعة.
    public function __construct(public int $batchId)
    {
        $this->onConnection('redis-imports');
