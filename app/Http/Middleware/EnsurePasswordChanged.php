...
class EnsurePasswordChanged
{
    ...
    private const ALLOWED = [
        ...
        'api/logout',
        'api/me',
        // الدخول ليس إجراءً على المنصّة بل الطريق إليها. استثناؤه إلزامي:
        // الواجهة تُرفق الرمز المخزَّن بكل طلب، فمستخدمٌ ترك شاشة التغيير دون
        // إتمامها يبقى رمزه في المتصفّح، فيُردّ طلب دخوله التالي بـ403 ويُقال
        // له إن بياناته خاطئة وهي صحيحة — فيدور بلا مخرج حتى يمسح تخزين
        // المتصفّح. الدخول من جديد هو المخرج المشروع لا بابٌ يُسدّ.
        'api/login',
    ];
