...
//
//  مسار المرشّح عليه: يُدخل هويته ← يراجع بياناته ← يوقّع ويقرّ ← يُرسَل
//  أمر طباعة بطاقته إلى جهاز مسؤول المرشحين ← تعود الشاشة صفراً للتالي.
//
...
//   • لا بيان قبل مطابقة رقم الهوية — كبوّابة المرشّح تماماً.
//   • رمز الكشك نطاقه يومٌ واحد وقابل للإبطال، فتسريبه خسارة يوم.
//   • رمز الجلسة (accessToken) في ذاكرة المتصفّح، عمره خمس دقائق: المرشّح
...
class KioskController extends Controller
{
    ...
    private const ACCESS_TTL = 300;         // عمر جلسة المرشّح على الكشك: ٥ دقائق
    ...
    public function identify(Request $request, string $token)
    {
        ...
        RateLimiter::clear($idKey);              // مرشّحٌ صحيح لا يُعاقَب
    ...
    // ═══════════════════════════════════════════════════════
    //  ٤) أمر طباعة البطاقة — يدخل طابور جهاز مسؤول المرشحين
    // ═══════════════════════════════════════════════════════
    ...
    // ما يراه المرشّح عن نفسه قبل أن يوقّع. الإقرار لا يكون إقراراً إن وقّع
    ...
    // رقم الهوية مقنّعاً: يطمئن المرشّح أنه هو، ولا يعرض الرقم كاملاً على
