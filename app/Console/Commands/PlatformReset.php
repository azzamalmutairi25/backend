...
class PlatformReset extends Command
{
    ...
    private const REFERENCE = [
        ...
        'technical_areas',
        'technical_sub_areas',   // تفصيل المجال — يذهب مع مجاله ويبقى ببقائه
        'competencies',
        'ranks',
        'activity_competency',
        // مصفوفة (رتبة × كفاءة): المستوى المطلوب من كل رتبة. مرجعٌ معتمد
        // كالكفاءات والرتب اللتين يربط بينهما — لا تُمسح إلا معهما، وإلا
        // سقط تحليل الفجوة صامتاً إلى عمودَي الفئة وقرأه أحدٌ نتيجةً.
        'rank_competency_targets',
        // نسبةُ المجال لقطاعاته — تذهب مع مجالها وتبقى ببقائه، كالمجالات
        // الفرعية. مجالٌ يبقى بلا قطاعٍ يبقى لا يظهر في أي نموذج.
        'technical_area_sectors',
        // وسمُ المستشار بمجالاته — إعدادُ حسابٍ لا بيانَ تشغيل، ويبقى ببقاء
        // حسابه. وحسابٌ يُمحى يأخذ وسمَه معه بالتتالي.
        'user_technical_areas',
        // وقطاعاتُه كذلك — إعدادُ حسابٍ يبقى ببقائه
        'user_sectors',
        // ── متقاعدان ──
        // «مجالات الخبرة» كانت مرجعَ وسم المقيّمين، ومطابقتُها بالمشارك بحثاً
        // نصّياً في نثر سيرته. حلّ محلّها وسمُ الطرفين من مرجعٍ واحد، فلم يعد
        // لهما قارئ. ويبقيان في القاعدة حتى يصل ملفُّ مجالات المستشارين —
        // فوسمٌ قائم قد يُنقَل، وإسقاطُه قبل ذلك يُتلف ما لا يُستعاد.
        // يُسقطان في تنظيفٍ لاحق مع عمود التصنيف الأمني.
        'expertise_areas',
        'user_expertise',
    ];
