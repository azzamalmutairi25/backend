...
//   ١) ينقل المرشحين والمستخدمين وصفوف التوزيع إلى القطاع المعتمد المقابل.
//   ٢) يُعيد كتابة بادئة رمز المشارك (DA-001 → CD-001) على المرشّح وعلى
...
class RetireDemoSectors extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->table(
            ['من', 'إلى', 'مرشحون', 'مستخدمون', 'صفوف توزيع'],
            array_map(fn ($p) => [
