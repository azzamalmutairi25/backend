...
class CvSheetService
{
    ...
    private const DEGREES = [
        'highschool' => 'ثانوية عامة', 'diploma' => 'دبلوم', 'bachelor' => 'بكالوريوس',
        'master' => 'ماجستير', 'doctorate' => 'دكتوراه', 'fellowship' => 'زمالة',
    ];
...
HTML;
    ...
    // ── الإقرار والتوقيع ──
    //
    // النموذج يُطبع ليُقرّ المشارك بصحّة بياناته، والاستقبال يلتقط توقيعه
