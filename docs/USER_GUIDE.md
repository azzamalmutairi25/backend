...
إلزامي عند أول دخول، ومتاح في أي وقت بعده. النظام لا يفتح لك أي شاشة أخرى قبل
إتمامه — وهو منعٌ خادمي لا واجهي: لن ينفع تجاوزه بتغيير الرابط.
...
| ٢ | **الرتب** | الإعدادات ← الرتب | تُستعمل في نموذج الترشيح وفي تصنيف الفئة القيادية |
...
أحد عشر دوراً. الصلاحية تأتي من الدور، ويجوز لمدير النظام منح استثناءات فردية
...
| **مسؤول الاستقبال** RECEPTIONIST | رؤية الأسماء وتسجيل حضور أي جلسة، إرسال الدعوات |
...
```text
ترشيح  →  اعتماد الترشيح  →  جدولة  →  توزيع المقيّمين  →  حضور
...
![طلبات تحديث البيانات](guide-images/update-requests.png)
...
- **الرتب** — قائمة الرتب المستعملة في الترشيح.
