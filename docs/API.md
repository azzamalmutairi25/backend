...
`sectorCode` يُقبل بالرمز الداخلي أو ببادئة المشارك أو **باسم القطاع العربي**؛ والاسم يُطبَّع قبل المطابقة (تُزال التشكيلات و«ال» التعريف، وتُوحَّد الهمزات والتاء المربوطة والياء). `mobile` و`email` وحدهما اختياريان.
